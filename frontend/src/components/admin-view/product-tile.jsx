...
function AdminProductTile({
  ...
  return (
    <Card className="w-full mx-auto bg-card border-border shadow-sm overflow-hidden flex flex-col h-full">
      ...
      <CardContent className="pt-3 pb-1 flex-1 flex flex-col">
        ...
        <div className="flex items-center gap-1.5 text-xs text-muted-foreground mb-1">
          ...
          <span>
            Total Stock:{" "}
            <strong className={isOutOfStock ? "text-red-500" : "text-foreground"}>
              {totalStock}
            </strong>
          </span>
        </div>

        {/* Low-stock sizes breakdown — mt-auto pushes to bottom of content */}
      ...
      <CardFooter className="flex justify-between items-center gap-2 pt-2 pb-4 px-4">
        <Button
          size="sm"
          className="flex-1"
          onClick={() => {
