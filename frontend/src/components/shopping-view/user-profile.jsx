...
import { RefreshCw, Camera, Settings, MapPin, User, Shirt, ShoppingBag } from "lucide-react";
...
function UserProfile() {
  ...
  // Mock Fashion Preferences State
          ...
          <CardContent className="p-8">
            ...
            <form onSubmit={handleSavePreferences} className="space-y-6">
              ...
              <div className="flex justify-end pt-4 border-t border-border/50">
                <Button type="submit" className="bg-gradient-premium bg-gradient-premium-hover rounded-xl text-white font-bold px-8">
                  Save Preferences
                </Button>
              </div>
            </form>
