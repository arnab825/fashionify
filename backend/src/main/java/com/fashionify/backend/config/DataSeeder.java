...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedProducts() {
        // Purge existing products (old data without tags, etc.)
        ...
        if (!existing.isEmpty()) {
            ...
            System.out.println("🗑️  Purged " + existing.size() + " old products");
        }
        ...
        createProduct(
            ...
            // Tags aligned with men category: pure cotton, everyday wear
            List.of("pure cotton", "casual", "minimalist", "summer wear", "classic fit")
        );
        ...
        createProduct(
            ...
            List.of("premium cotton", "casual", "business casual", "slim fit", "formal")
        );
        ...
        createProduct(
            ...
            List.of("stretch denim", "slim fit", "casual", "urban", "premium cotton")
        );
        ...
        createProduct(
            ...
            List.of("linen", "casual", "summer wear", "relaxed fit", "minimalist")
        );
        ...
        createProduct(
            ...
            List.of("streetwear", "casual", "urban", "relaxed fit", "cozy")
        );
        ...
        createProduct(
            ...
            List.of("floral", "elegant", "party wear", "summer wear", "trendy")
        );
        ...
        createProduct(
            ...
            List.of("oversized", "streetwear", "trendy", "casual", "western")
        );
        ...
        createProduct(
            ...
            List.of("oversized", "streetwear", "comfort fit", "casual", "pure cotton")
        );
        ...
        createProduct(
            ...
            List.of("trendy", "casual", "minimalist", "summer wear", "pure cotton")
        );
        ...
        createProduct(
            ...
            List.of("playful", "soft cotton", "casual", "vibrant colors", "summer wear")
        );
        ...
        createProduct(
            ...
            List.of("sports", "lightweight", "comfort", "trending", "premium")
        );
        ...
        createProduct(
            ...
            List.of("casual", "everyday", "trending", "comfort", "lace-up")
        );
        ...
        createProduct(
            ...
            List.of("sports", "lightweight", "premium", "comfort", "trending")
        );
        ...
        createProduct(
            ...
            List.of("trending", "premium", "everyday carry", "gifting", "minimalist")
        );
        ...
        createProduct(
            ...
            List.of("everyday carry", "premium", "minimalist", "trending", "classic")
        );
        ...
        createProduct(
            ...
            List.of("classic", "minimalist", "premium", "everyday carry", "fashion essential")
        );

        System.out.println("✅ Sample products seeded with category-aligned tags");
    }
    ...
    /**
     * Creates a product with size variants and required tags.
     * Tags must be 1–5 non-blank strings sourced from the category tag taxonomy.
     */
    private void createProduct(
            String title, String description, String category, String brand,
